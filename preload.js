...
contextBridge.exposeInMainWorld('api', {
  ...
  onJavaMissing: (cb) => ipcRenderer.on('java:missing', (_e, p) => cb(p)),
  onJavaRepair: (cb) => ipcRenderer.on('java:repair-progress', (_e, p) => cb(p)),
  javaRepair: () => ipcRenderer.invoke('java:repair'),
